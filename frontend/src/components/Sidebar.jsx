    ...
    <aside className="w-64 bg-[#0A0F1D] border-r border-white/10 flex flex-col hidden md:flex z-40 shadow-[10px_0_30px_rgba(0,0,0,0.5)]">
      <div className="p-5 flex-1">
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-2 rounded-xl text-[12px] font-bold transition-all mb-6 ${currentView === 'chat'
        ...
        <nav className="space-y-1.5">
          ...
          <div
            ...
            className={`px-3 py-2.5 rounded-xl flex items-center gap-3.5 text-[12px] font-semibold cursor-pointer transition-all group ${currentView === 'analytics'
